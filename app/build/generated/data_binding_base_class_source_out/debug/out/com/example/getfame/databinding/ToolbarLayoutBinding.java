...
public final class ToolbarLayoutBinding implements ViewBinding {
  ...
  private ToolbarLayoutBinding(@NonNull RelativeLayout rootView, @NonNull ImageView toolbarImage) {
  ...
  public static ToolbarLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ToolbarLayoutBinding((RelativeLayout) rootView, toolbarImage);
    }
